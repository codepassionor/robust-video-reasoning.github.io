...
![点击 Fork](https://robust-video-reasoning.github.io/images/build_own_website/fork.png)

仓库名称填写 `username.github.io`，注意 `username` 指的是用户名不是昵称。

![设置仓库名称](https://robust-video-reasoning.github.io/images/build_own_website/repositoryname.png)

点击 Create fork，完成创建。这样你就有了你的第一个博客仓库，**以后的操作都在你自己的仓库进行**。

这个地方也不要忘记改成你自己的网址哦~

![设置网址](https://robust-video-reasoning.github.io/images/build_own_website/modifywebsite.png)
...
- ### 修改 README.md 文件
    ...
    ![点击笔](https://robust-video-reasoning.github.io/images/build_own_website/pen.png)
    ...
    ![切换预览](https://robust-video-reasoning.github.io/images/build_own_website/preview.png)
...
- ### 修改 _config.yml 文件
    ...
    - **网站名称和网站描述**
        ...
        ![名称和描述](https://robust-video-reasoning.github.io/images/build_own_website/name&desc.png)

        这个根据你自己的喜好来设置，不一定要仿造我的模式。比如你可以给你的博客网站取一个有特色的名字，网站描述也可以是简短的自我介绍或个性签名等任何你想表达的内容。

    - **个人头像和网站 logo**

        ![头像和 logo](https://robust-video-reasoning.github.io/images/build_own_website/avatar&ico.png)
        ...
        ![PicGo 设置](https://robust-video-reasoning.github.io/images/build_own_website/picgoset.png)

        ![Markdown 形式](https://robust-video-reasoning.github.io/images/build_own_website/markdownimg.png)

    - **个人社交链接**

        ![社交链接](https://robust-video-reasoning.github.io/images/build_own_website/links.png)

        填用户名就好，也可以不填。

    - **脚注和网址**

        ![版权标注和网址](https://robust-video-reasoning.github.io/images/build_own_website/footer&url.png)

    - **Gitalk 配置信息**

        ![Gitalk 配置](https://robust-video-reasoning.github.io/images/build_own_website/gitalk.png)
